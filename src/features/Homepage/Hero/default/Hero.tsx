        ...
        >
            ...
            <div className="max-w-4xl mx-auto relative z-20 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-gray-300">
                    <div className="p-4 rounded-2xl bg-gray-800/20 backdrop-blur-sm border border-gray-700/50">
                        ...
                        <h3 className="font-semibold text-white mb-1">AI-Generated Plans</h3>
                        <p className="text-sm">Personalized workouts created just for your goals and fitness level.</p>
                    </div>
                    <div className="p-4 rounded-2xl bg-gray-800/20 backdrop-blur-sm border border-gray-700/50">
                        <div className="w-10 h-10 rounded-full bg-lime-500/20 flex items-center justify-center mb-3 mx-auto">
                            <Timer className="w-5 h-5 text-lime-300" />
                        </div>
                        <h3 className="font-semibold text-white mb-1">Quick & Efficient</h3>
                        <p className="text-sm">Get workout plans in seconds that fit your available time and equipment.</p>
                    </div>
                    <div className="p-4 rounded-2xl bg-gray-800/20 backdrop-blur-sm border border-gray-700/50">
                        <div className="w-10 h-10 rounded-full bg-lime-500/20 flex items-center justify-center mb-3 mx-auto">
                            <Medal className="w-5 h-5 text-lime-300" />
                        </div>
                        <h3 className="font-semibold text-white mb-1">Expert-Verified</h3>
                        <p className="text-sm">All workouts reviewed by certified fitness professionals for safety.</p>
                    </div>
                </div>
            </div>
        </section>
