...
/**
 * Homepage-specific demo navigation component shown only in demo mode
...
const DemoNav: React.FC<DemoNavProps> = ({
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            const demoNav = document.getElementById('homepage-demo-nav');
            if (demoNav) {
