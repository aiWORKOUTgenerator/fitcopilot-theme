/**
 * Modern Theme Button Component
 * 
 * Button implementation specific to the modern theme
 */
...
/**
 * Button component for the modern theme
 */
export const ModernButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(({
    children,
    className,
    size = 'medium',
    variant = 'primary',
