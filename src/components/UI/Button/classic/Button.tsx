/**
 * Classic Theme Button Component
 * 
 * Button implementation specific to the classic theme
 */
...
/**
 * Button component for the classic theme
 */
export const ClassicButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(({
    children,
    className,
    size = 'medium',
    variant = 'primary',
