/**
 * Minimalist Theme Button Component
 * 
 * Button implementation specific to the minimalist theme
 */
...
/**
 * Button component for the minimalist theme
 */
export const MinimalistButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(({
    children,
    className,
    size = 'medium',
    variant = 'primary',
