/**
 * Sports Theme Button Component
 * 
 * Button implementation specific to the sports theme
 */
...
/**
 * Button component for the sports theme
 */
export const SportsButton = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(({
    children,
    className,
    size = 'medium',
    variant = 'primary',
...
SportsButton.displayName = 'SportsButton';
